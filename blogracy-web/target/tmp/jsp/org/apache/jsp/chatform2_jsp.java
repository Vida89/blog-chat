...
public final class chatform2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
pageContext.setAttribute("loc",  Configurations.getUserConfig().getUser().getHash().toString());
      ...
      out.write("\t<script type=\"text/javascript\" src=\"chat files/chat2.js\"></script>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<button id=\"leaveB\" disabled=\"disabled\">Leave</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
